...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Jan-2025 às 01:47
...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('admin','cliente','tecnico_suporte') NOT NULL,
  `status` enum('ativo','inativo') DEFAULT 'ativo',
  `data_criacao` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Índices para tabela `planos_hospedagem`
--
ALTER TABLE `planos_hospedagem`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `servicos_email`
--
...
--
-- AUTO_INCREMENT de tabela `planos_hospedagem`
--
ALTER TABLE `planos_hospedagem`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `servicos_email`
--
ALTER TABLE `servicos_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
